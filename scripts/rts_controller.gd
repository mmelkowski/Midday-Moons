...
func _move(delta: float) -> void:
	var move_delta_z = Input.get_axis("camera_forward", "camera_backward")
	var move_delta_x = Input.get_axis("camera_left", "camera_right")
...
func _rotate(delta: float) -> void:
	...
	# add -1 to invert rotation
	rotate_y(rotation_delta * delta * camera_rotate_speed * -1)
